...
\bottomrule
\multicolumn{5}{@{}l@{}}{\tiny N/A = no prefetches issued; high acc.\ expected for synthetic regular patterns}\\
\multicolumn{5}{@{}l@{}}{\tiny (real SPEC traces typically 60--85\% due to mixed irregular phases)}\\
\end{tabular}
\end{adjustbox}
\end{block}
