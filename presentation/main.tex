...
\begin{frame}[plain]
  ...
  \begin{center}
    \small
    \texttt{github.com/gurudeepDev/ghb-adaptive-prefetcher}
    \quad|\quad
...
\midrule
\rowcolor{green!10}
mcf     & 0.1709 & 0.1709 (=)        & 0.1709 (=)                     & \good{0.1709 (=)}\\
\rowcolor{green!10}
...
\rowcolor{yellow!10}
bzip2   & 1.0206 & 1.1278 (+10.5\%)  & 1.1316 (+10.9\%)               & \good{1.1317 (+10.9\%)}\\
\rowcolor{yellow!10}
...
\midrule
\rowcolor{iitblue!10}
\textbf{H-Mean} & 1.000 & 1.091 & \hl{1.097} & \good{\textbf{1.097}}\\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{block}
...
\addplot[fill=gray!40,draw=gray]
  coordinates {(mcf,0.1709)(lbm,2.0)(gcc,0.6377)(sphinx3,4.0)(bzip2,1.0206)(ammp,0.7914)(astar,0.9716)};
\addplot[fill=iitblue!60,draw=iitblue]
  coordinates {(mcf,0.1709)(lbm,2.9443)(gcc,0.6377)(sphinx3,4.0)(bzip2,1.1316)(ammp,1.4092)(astar,1.2036)};
\addplot[fill=darkgreen!70,draw=darkgreen]
  coordinates {(mcf,0.1709)(lbm,2.9438)(gcc,0.6377)(sphinx3,4.0)(bzip2,1.1317)(ammp,1.4096)(astar,1.2039)};
...
\tiny
\begin{itemize}
  \item \good{+78.1\%} ammp, \good{+47.2\%} lbm, \good{+23.9\%} astar, \good{+10.9\%} bzip2
...
PC/DC uses \textit{PC-indexed} chains $\Rightarrow$ \good{98.8\%} accuracy
\end{alertblock}
...
\textbf{BM} & \textbf{Stride} & \textbf{G/DC} & \textbf{PC/DC} & \textbf{\good{Adaptive}}\\
\midrule
mcf     & 15,620   & 3,919,473 & 0       & \good{0}\\
lbm     & 2        & 612       & 1,876   & \good{1,885}\\
gcc     & 9        & 6,244,428 & 45      & \good{\textbf{0}}\\
sphinx3 & 0        & 2,716,495 & 0       & \good{0}\\
bzip2   & 2,313    & 3,743,189 & 4,092   & \good{4,086}\\
ammp    & 1,351    & 2,479,583 & 16,974  & \good{16,862}\\
astar   & 1        & 5,561,513 & 325     & \good{280}\\
\midrule
\rowcolor{iitblue!10}
\textbf{Total} & 19,296 & \bad{24,665,293} & 23,312 & \good{\textbf{23,113}}\\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{block}
...
\tiny
GHB G/DC: \bad{24.7M useless} prefetches --- crippling\\
GHB PC/DC \& Adaptive: only $\sim$23K --- \good{1000$\times$ cleaner}\\
\good{Adaptive eliminates gcc's 45 useless} pf via phase switch!
\end{exampleblock}
\end{columns}
\end{frame}
...
\midrule
mcf     & 40.00 & 40.00  & \good{39.68}  & 40.00  & 40.00\\
...
bzip2   & 69.57 & \good{62.23} & \bad{72.66} & \good{62.04} & \good{62.03}\\
...
\midrule
IPC H-Mean         & \hl{1.097} & \good{\textbf{1.097}}\\
Pf Accuracy (wgt)  & 98.8\%& \good{98.8\%}\\
Total Useless Pf   & 23,312& \good{23,113}\\
Phase Switches     & ---   & \good{1} (verified)\\
...
\textcolor{darkgreen}{\ding{52}} & \textbf{Good (pollution)}: G/DC: 24.7M useless; Ours: $\approx$23K ($\sim$1000$\times$ less)\\[2pt]
...
\small
\begin{itemize}\setlength\itemsep{1pt}
  \item \good{1 phase switch} confirmed: gcc pollution \good{0 vs 45}; accuracy \good{100\% vs 99.2\%}
  \item Turns off prefetch on irregular phases $\Rightarrow$ zero wasted BW
...
Accuracy & \bad{15.8\%} & \good{98.8\%}\\
Pollution & \bad{24.7M+} & \good{23K}\\
...
\small
\begin{itemize}\setlength\itemsep{1pt}
  \item gcc (irregular): d=4 $\rightarrow$ d=0; pollution $45\rightarrow 0$
  \item Regular benchmarks: unchanged (d=4 always)
...
\begin{enumerate}\setlength\itemsep{2pt}
  ...
  \item \textbf{Achieved} \good{98.8\%} weighted prefetch accuracy
  \item \textbf{Eliminated} gcc pollution: 0 vs 45 useless pf; 1 phase switch confirmed
...
\begin{center}
  ...
  \footnotesize\texttt{github.com/gurudeepDev/ghb-adaptive-prefetcher}
\end{center}
\end{frame}
